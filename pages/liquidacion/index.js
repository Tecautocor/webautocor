...
import { useListStockQuery } from "../../lib/hooks";
...
export default function Liquidacion() {
  ...
  const params = { page: router.query.page, minDays: MIN_DAYS, sort: "days_desc" };
  const { data, isLoading, isError } = useListStockQuery(params);

  return (
    <Layout selected="liquidacion">
      <div className="bg-gray-50 flex justify-center flex-col items-center py-10">
        <SectionText
          title="¡Esta puede ser tu última oportunidad!"
          subtitle="¡Llévate el seminuevo de tus sueños a precio especial!"
          boldTitle
        />
      </div>
      ...
      <div className="bg-white flex justify-center flex-col items-center pt-4 pb-4">
        <div className="pb-4 flex-col justify-center items-center">
          ...
          {!isLoading && !isError && data && <List list={data.entitydata} liquidacion />}
