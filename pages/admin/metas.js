          ...
          <table className="text-sm w-full">
            ...
            <tfoot>
              <tr className="border-t-2 border-gray-300 bg-gray-50">
                <td className="py-3 pr-3 font-bold text-gray-800 sticky left-0 bg-gray-50">
                  Total Empresa
                </td>
                {totalesPorMes.map((m) => (
                  <td key={m.mes} className="py-2 px-1 text-center">
                    <div
                      className={`w-20 mx-auto rounded py-1.5 text-sm font-bold text-gray-800 border ${claseCumplimiento(
                        anio,
                        m.mes,
                        m.metaUnidades,
                        m.real
                ...
                <td className="py-2 pl-3 text-right font-bold text-gray-800">
                  {totalGeneralAnual}
                </td>
              </tr>
            </tfoot>
