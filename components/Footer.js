...
const navigation = [
  {
    name: "Facebook",
    href: "https://www.facebook.com/autocor.ec",
    icon: (props) => (
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/autocor.ec/",
    icon: (props) => (
      <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
        <path
          fillRule="evenodd"
          ...
          <div className="flex justify-center space-x-6 md:order-2">
            {navigation.map((item) => (
              <a
                key={item.name}
                href={item.href}
                className="text-secondary hover:text-main hover:scale-110 transition-colors"
              >
